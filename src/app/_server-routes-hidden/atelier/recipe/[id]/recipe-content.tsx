...
export default function RecipeDetailContent() {
    ...
    useEffect(() => {
        if (!user || !id || id === 'placeholder') return;
    ...
    if (isLoading && id !== 'placeholder') return <div className="flex h-screen w-full items-center justify-center bg-background"><Loader2 className="h-12 w-12 animate-spin text-amber-500" /></div>;

    if (!recipe && id !== 'placeholder') return (
